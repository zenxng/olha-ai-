...
//#endif
    ...
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, bool bToolTip = false, const char* ToolTipMsg = "", const char* ToolTipIcon = "");
    ...
    IMGUI_API void          DebugDrawCursorPos(ImU32 col = IM_COL32(255, 255, 105, 180));
    IMGUI_API void          DebugDrawLineExtents(ImU32 col = IM_COL32(255, 255, 105, 180));
    IMGUI_API void          DebugDrawItemRect(ImU32 col = IM_COL32(255, 255, 105, 180));
