...
namespace ImGui
{
    ...
    IMGUI_API bool          ResourceListButton(const char* Label, uint32_t ResourceState, ImVec2 SizeArg, ImGuiButtonFlags flags);
    ...
    IMGUI_API bool          SubTab(const char* Label, bool Enabled);
